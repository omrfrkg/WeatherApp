...
export default function HomeScreen() {
  const havaDurumu = new Map([
    ["Partly cloudy", "Parçalı bulutlu"],
    ["Moderate rain", "Orta derecede yağmur"],
    ["Patchy rain possible", "Parçalı yağmur mümkün"],
    ["Patchy rain nearby", "Yakınlarda düzensiz yağmur"],
    ["Sunny", "Güneşli"],
    ["Clear", "Açık"],
    ["Overcast", "Bulutlu"],
    ["Cloudy", "Bulutlu"],
        ...
        <SafeAreaView className="flex flex-1">
          ...
          <View className="mx-4 flex justify-around flex-1 mb-2">
            ...
            <View className="space-y-2">
              ...
              <Text className="text-center text-white text-xl tracking-widest">
                {havaDurumu.get(current?.condition?.text)}
              </Text>
            </View>
            {/* other stats */}
            <View className="flex-row justify-between mx-4">
              ...
              <View className="flex-row space-x-2 items-center">
                {dayjs().hour() < 18 ? (
                  ...
                  <MoonIcon size={22} color={"white"} className="h-6 w-6" />
                )}
          ...
          <View className="mb-2 space-y-3">
            <View className="flex-row items-center mx-5 space-x-2">
              ...
              <Text className="text-white text-base">Günlük Tahminler</Text>
            </View>
            <ScrollView
              horizontal
